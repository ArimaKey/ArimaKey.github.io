  ...
  return (    
    <nav className="bg-[#111111] fixed w-full z-10">
      <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto">
        ...
        <div className="">
          <ul className="flex font-medium p-0 my-0 sm:mx-3">
            <li> <NavLink to="/" className={ ({ isActive }) => `hidden md:block py-4 px-3 text-zinc-200 hover:text-zinc-400 + ${isActive ? 'bg-zinc-900' : 'bg-transparent'}` } >Home</NavLink> </li>
